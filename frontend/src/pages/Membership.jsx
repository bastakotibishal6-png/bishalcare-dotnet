...
const Membership = () => {
  ...
  const handleJoinClick = async () => {
    ...
    try {
      ...
      setIsMember(true);
      alert('Welcome to  Membership! You now get 15% off all orders + a free gift with every order.');
    ...
    <div className="membership-page">
      <section className="membership-hero" data-aos="fade-in">
        <div className="container">
          <h1 data-aos="fade-up">Bishal Care Membership</h1>
      ...
      <div className="container">
        <section className="benefits-section" data-aos="fade-up">
          ...
          <div className="benefits-grid">
            <div className="benefit-card" data-aos="zoom-in" data-aos-delay="100">
              <div className="benefit-icon"><FiStar size={28} /></div>
            ...
            <div className="benefit-card" data-aos="zoom-in" data-aos-delay="200">
              <div className="benefit-icon"><FiGift size={28} /></div>
            ...
            <div className="benefit-card" data-aos="zoom-in" data-aos-delay="300">
              <div className="benefit-icon"><FiTruck size={28} /></div>
              <h3>Free Shipping</h3>
            ...
            <div className="benefit-card" data-aos="zoom-in" data-aos-delay="400">
              <div className="benefit-icon"><FiCalendar size={28} /></div>
              <h3>Early Access</h3>
            ...
            <div className="benefit-card" data-aos="zoom-in" data-aos-delay="500">
              <div className="benefit-icon"><FiUsers size={28} /></div>
        ...
        <section className="pricing-section" data-aos="fade-up">
          <div className="pricing-card">
            ...
            <p className="savings-text">Save RS 900+ annually on average</p>
            ...
            {statusLoading ? (
              ...
              <div className="member-active">
                <div className="member-active-box">
                  <p className="member-active-title">✓ You are a Premium Member</p>
                  <p className="member-active-sub">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? 'Activating...' : !isLoggedIn ? 'Sign In to Join' : 'Join Now - RS 99/year'}
              </button>
            )}

            {isLoggedIn && !isMember && !statusLoading && (
              <p className="logged-in-as">Logged in as: {userEmail}</p>
            )}
          </div>
        </section>
        ...
        <section className="comparison-section" data-aos="fade-up">
          ...
          <div className="comparison-table">
            ...
            <div className="comparison-row">
              ...
              <div className="row-cell">RS 20 (under RS 200)</div>
        ...
        <section className="faq-section" data-aos="fade-up">
          ...
          <div className="faq-list">
            <div className="faq-item" data-aos="fade-up" data-aos-delay="100">
              ...
              <p>Once you join for RS 99/year, you instantly unlock all premium benefits including 15% off all products, free shipping, complimentary gifts, and exclusive access to events and new launches.</p>
            </div>
            ...
            <div className="faq-item" data-aos="fade-up" data-aos-delay="400">
              ...
              <p>With 15% off all products plus free shipping, most members save RS 900+ per year on average. The membership pays for itself after just a few orders!</p>
            </div>
          </div>
        </section>
          ...
          <section className="cta-section" data-aos="fade-up">
            <div className="cta-content">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? 'Activating...' : isLoggedIn ? 'Join for RS 99/Year' : 'Sign In to Join'}
              </button>
            </div>
          </section>
        )}
