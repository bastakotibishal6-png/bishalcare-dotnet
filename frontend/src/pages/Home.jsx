    ...
    <div className="home-page">
      ...
      <section className="hero" data-aos="fade-in">
        <div className="hero-content">
          <h1 data-aos="fade-down" data-aos-delay="200">Bishal Care</h1>
          <p data-aos="fade-up" data-aos-delay="400">Elevate Your Charming Personality.</p>
      ...
      <section className="features section-padding">
        <div className="container">
          <h2 className="text-center mb-5" data-aos="fade-up">Why Bishal Care</h2>
