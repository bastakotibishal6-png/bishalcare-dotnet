            ...
            <div className="order-summary-card">
              ...
              <div className="summary-items">
                {cart.items.map(item => (
                  <div key={item.cartItemId} className="summary-item">
                    ...
                    <p className="item-price">RS {item.subtotal.toFixed(2)}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="price-breakdown">
                ...
                {isMember && (
                  <div className="price-row discount">
                    ...
                    <span>-RS {memberDiscount.toFixed(2)}</span>
                  </div>
                )}
                ...
                {shippingFee > 0 && (
                  <div className="shipping-notice">
                    <p>Add RS {(200 - subtotal).toFixed(2)} more for free shipping</p>
                  </div>
                )}
              ...
              {isMember && (
                <div className="member-benefits-box">
                  ...
                  <ul>
                    <li>✓ 15% discount — RS {memberDiscount.toFixed(2)} saved</li>
                    <li>✓ Free shipping</li>
