                ...
                {isEditMode ? (
                  <form onSubmit={handleProfileUpdate} className="edit-form">
                    <div className="info-grid">
                      ...
                      <div className="info-item-edit full-width">
                        <label>Address</label>
                      ...
                      <div key={order.orderId} className="order-card">
                        <div className="order-header">
                          ...
                          <div className="order-header-right">
                            ...
                            <p className="order-total">RS {order.finalTotal?.toFixed(2)}</p>
                          </div>
                        </div>
                            ...
                            <div key={index} className="order-item-row">
                              ...
                              <div>
                                ...
                                <p className="order-item-meta">
                                  {item.isFreeGift ? '🎁 Free Gift' : `Qty: ${item.quantity} × RS ${item.price?.toFixed(2)}`}
                                </p>
                              </div>
                            </div>
                          ))}
                        ...
                        <div className="order-footer">
                          ...
                          {order.discountAmount > 0 && (
                            <p className="order-savings">
                              Saved: RS {order.discountAmount?.toFixed(2)}
                            </p>
                          )}
                        </div>
                      </div>
                ...
                {membershipData?.isMember ? (
                  ...
                  <div className="membership-inactive">
                    ...
                    <p className="membership-price-note">
                      <strong>Just RS 99/year</strong> — Save RS 900+ annually on average
                    </p>
                    <button
                      className="btn-primary membership-join-btn"
